---
trigger: glob
globs: "**/src-tauri/**/*.rs,**/src-tauri/Cargo.toml,**/src-tauri/tauri.conf.json,**/src-tauri/tauri.conf.json5,**/src-tauri/tauri.conf.toml,**/tauri.conf.json,**/tauri.conf.json5,**/tauri.conf.toml"
---
